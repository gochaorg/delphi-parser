...
public interface DelphiVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link DelphiParser#designatorItem}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDesignatorItem(DelphiParser.DesignatorItemContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link DelphiParser#colonConstruct}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitColonConstruct(DelphiParser.ColonConstructContext ctx);
	/**
	 * Visit a parse tree produced by {@link DelphiParser#operator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOperator(DelphiParser.OperatorContext ctx);
	/**
